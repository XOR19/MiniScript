...
final class MiniScriptImmutableList<E> implements List<E> {
	...
	private MiniScriptImmutableList(E[] array, int start, int end){
		this.array = array;
		this.start = start;
		this.end = end;
	}
	...
	public List<E> subList(int start, int end) {
		...
		return new MiniScriptImmutableList<E>(array, this.start+start, this.start+end);
	}
